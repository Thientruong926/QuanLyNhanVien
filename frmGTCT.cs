...
{
    public partial class frmGTCT : Form
    {
        public frmGTCT()
        {
            InitializeComponent();
        ...
        private void frmGTCT_Load(object sender, EventArgs e)
        {
            update();
        }
        ...
        private void thànhViênToolStripMenuItem1_Click(object sender, EventArgs e)
        {
